package es.kybele.cevinedit.validation.editors.er_crows_foot.diagram.parsers;
	...
	public IParserEditStatus isValidEditString(IAdaptable adapter,
		...
		if (values == null) {
			return new ParserEditStatus(
					...
					NLS.bind(
							es.kybele.cevinedit.validation.editors.er_crows_foot.diagram.part.Messages.MessageFormatParser_InvalidInputError,
